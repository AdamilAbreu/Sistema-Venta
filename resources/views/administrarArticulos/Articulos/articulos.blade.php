...
<body>
    ...
    <h1 class="text-white text-center mt-3">Lista de Articulos!</h1>
   <div  class="container d-flex gap-4">
    <div class="container cont-agregar-informacion mt-4 w-50">
        <form action="{{ url('articulos') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <h2 class="text-center text-white">Administrar Articulos</h2>
            <div class="row mt-2">
            ...
            <div class="d-grid w-100">
                <button class="btn btn-success w-100" type="submit" >Agregar Articulos</button>
            </div>
        </form>
    </div>
